...
<html>
<head>
	<title>Laporan Hasil Radiologi - SIMRS</title>
</head>
<style type="text/css">
	body{
	margin: auto;
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>:</td>
					<td><?php echo date_format(date_create($reg_radio['tanggal']),'d M Y'); ?></td>
...
<div id="data">
	<table>
		...
		<tbody>
			<tr>
				<td colspan="2" id="lab">RADIOLOGI</td>
			</tr>
			<?php
				$i=0;
...
<div class="data">
	<div id="d">
		<table>
			<tbody>
				<tr>
					<td style="text-align: justify;"><b>Keterangan/Kesimpulan :</b>  <?php echo $reg_radio['kesimpulan']; ?></td>
				</tr>
			</tbody>
		</table>
	</div>
