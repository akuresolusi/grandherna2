				...
				<tbody>
					...
					foreach($list as $value){
						...
						<tr>
							...
							<td>
								<a href='#' class='btn btn-primary btn-xs tooltips edit' data-original-title='Edit Data' value_id='".$value['id']."' value_lab='".$value['kategori']."' data-toggle='modal' data-target='#modaledit'><span class='icon-note'></span></a>
								<a href='#' class='btn btn-danger btn-xs tooltips hapus' data-original-title='Hapus Data' value_id='".$value['id']."' value_lab='".$value['kategori']."'><span class='icon-trash'></span></a>
							</td>
						</tr>";
					}
				?>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="container-fluid">
					<?php echo form_open(base_url().'laboratorium/proses_tambah_kategori'); ?>
...
<div class="modal fade" id="modaledit" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="container-fluid">
					<?php echo form_open(base_url().'laboratorium/proses_edit_kategori'); ?>
					<div class="form-group">
						<div class=" form-group">
							<label>Nama Kategori</label>
...
<script>
	...
	$(".edit").click(function(){
		...
		$("#kategori_input").val($(this).attr('value_lab'));
	});

	$(".hapus").click(function(){
		var poliklinik = $(this).attr('value_lab'); 
		var id = $(this).attr('value_id');
		var r = confirm("Yakin ingin menghapus data poliklinik ? "+ poliklinik);
	    if (r == true) {
	    	window.location = "<?php echo base_url('laboratorium/proses_hapus_kategori?id='); ?>" + id;
	    }
	});
