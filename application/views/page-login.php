...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Login | RSU. GRAND HERNA MEDAN</title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="<?php echo base_url(); ?>assets/pages/img/logo.png" alt="" width="120" /> </a>
                <h4>Sistem Informasi Rumah Sakit</h4>
                <h3>RSU GRAN HERNA THERESIA</h3>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
        ...
        <div class="copyright"> © 2018 <a href="http://akure-solusi.com">Akure Solusi.</a> All Rights Reserved </div>
        <!-- BEGIN CORE PLUGINS -->
